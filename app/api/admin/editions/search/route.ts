...
export async function GET(request: Request) {
  ...
  const selectFields = 'id, book_id, edition_name, edition_type, cover_image, original_retail_price, estimated_value, isbn, set_size, book:book_id(id, title, author), source:source_id(name)'
