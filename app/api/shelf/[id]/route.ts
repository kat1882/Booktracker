...
export async function PATCH(
  ...
  const allowed = ['reading_status', 'rating', 'date_read', 'date_started', 'review', 'notes', 'condition', 'purchase_price', 'purchase_location', 'purchase_date', 'for_sale', 'asking_price']
